...
const strings = {
  en: {
    ...
    nav_apps: "Our Apps",
    nav_technical_services: "Custom Services",
    ...
    // Hero
    hero_badge: "Pakistan's #1 Agri, Poultry & Livestock Platform",
    hero_headline_1: "Agri, Poultry &",
    hero_headline_2: "Livestock Business Platform Pakistan",
    hero_sub: "Pakistan's largest digital platform connecting farmers, poultry growers, livestock traders, buyers, and agri-consultants — verified profiles, live mandi rates, and consented business connections.",
    ...
    hero_sub_short: "Pakistan's largest platform for Agri, Poultry & Livestock — farmers, traders, buyers & consultants doing real business.",
    hero_search_placeholder: "Search people, produce, poultry, livestock or expertise…",
    hero_search_cta: "Search",
    hero_join_free: "Join free",
    hero_fact_roles: "member roles",
    hero_fact_cities: "cities",
    hero_fact_disciplines: "disciplines",

    // Exchange board
    board_title: "Mandi exchange · live board",
    board_updated: "Updated",
    board_col_commodity: "Commodity",
    board_col_mandi: "Mandi",
    board_col_rate: "Rate",
    board_footer_indicative: "Indicative rates — verify at your mandi",
    board_footer_live: "Live database rates — verify locally before transacting",
    board_full_market: "Full board",
  ...
  ur: {
    ...
    nav_projects: "ہمارے منصوبے",
    nav_apps: "ہمارے ایپس",
    nav_technical_services: "کسٹم سروسز",
    nav_education: "تعلیم",
    nav_login: "لاگ ان",
    ...
    // Hero
    hero_badge: "پاکستان کا نمبر 1 زرعی، مرغبانی و مویشی پلیٹ فارم",
    hero_headline_1: "زراعت، مرغبانی اور",
    hero_headline_2: "مویشی بزنس پلیٹ فارم پاکستان",
    hero_sub: "پاکستان کا سب سے بڑا ڈیجیٹل پلیٹ فارم جو کسانوں، مرغبانی پالنے والوں، مویشی تاجروں، خریداروں اور ماہرین کو جوڑتا ہے — تصدیق شدہ پروفائلز، لائیو منڈی ریٹس اور کاروباری رابطے۔",
    ...
    hero_sub_short: "زراعت، مرغبانی اور مویشی — کسان، تاجر، خریدار اور ماہرین ایک پلیٹ فارم پر۔",
    hero_search_placeholder: "لوگ، فصل، مرغی، مویشی یا مہارت تلاش کریں…",
    hero_search_cta: "تلاش",
    hero_join_free: "مفت شامل ہوں",
    hero_fact_roles: "رکن کے کردار",
    hero_fact_cities: "شہر",
    hero_fact_disciplines: "شعبے",

    // Exchange board
    board_title: "منڈی ایکسچینج · لائیو بورڈ",
    board_updated: "اپ ڈیٹ",
    board_col_commodity: "اجناس",
    board_col_mandi: "منڈی",
    board_col_rate: "ریٹ",
    board_footer_indicative: "اندازہ ریٹ — اپنی منڈی میں تصدیق کریں",
    board_footer_live: "لائیو ڈیٹابیس ریٹ — لین دین سے پہلے مقامی تصدیق کریں",
    board_full_market: "پورا بورڈ",

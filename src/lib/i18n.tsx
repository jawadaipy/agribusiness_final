...
const strings = {
  en: {
    ...
    hero_sub_short: "Verified growers, buyers, consultants, enterprises, and researchers — doing real business.",
    hero_search_placeholder: "Search people, produce, or expertise…",
  ...
  ur: {
    ...
    hero_sub_short: "تصدیق شدہ کسان، خریدار، ماہرین، کمپنیاں اور محقق — حقیقی کاروبار کرتے ہوئے۔",
    hero_search_placeholder: "لوگ، فصل یا مہارت تلاش کریں…",

...
export const SUBSCRIPTION_PLANS = {
  standard: {
    name: 'standard',
    label: 'Individual / Normal User',
    price: 500,
    trialDays: 14,
    forRoles: ['farmer', 'buyer', 'consultant', 'student'] as const,
    features: [
      '24-Hour Live Access to Mandi Rates',
      'Marketplace: 5 Posts per month',
      'Access to updated Agri Gov Schemes & Subsidies',
      'Access to AgriBusiness Networking & Direct Consents',
      'Access to Our Recommended Projects & RFPs',
      'Plant & Animal Clinical Telehealth Access',
    ],
  },
  enterprise: {
    name: 'enterprise',
    ...
    features: [
      ...
      'Access to updated Agri Gov Schemes & Corporate Tenders',
      'Priority Company Verification Badge',
      'Access to Our Recommended High-Value Projects',
      'Corporate Ad Studio & Sponsored Placement',
    ],
  },
} as const;
